...
### PostgreSQL
Postgres разворачивался на моей локальной машине MacBook Pro с чипом Apple M2 Pro и ядром Darwin Kernel Version 23.6.0. 
Поэтому на момент установки 06.11.2024 мне досталась версия
```
PostgreSQL 16.4 (Homebrew) on aarch64-apple-darwin23.6.0
```